...
#        Rule(LinkExtractor(restrict_xpaths=(".//ul[contains(@class, 'Pagination')]")), callback="parse_listing"),
#        Rule(LinkExtractor(restrict_xpaths=(".//div[@class='grid-container']//article//div[contains(@id, 'tile')]")), callback="parse_item"),
#    )
    custom_settings = {
...
#    """
    def parse(self, response):
        ...
        elif MESSAGE_INCIDENT_ERROR in response.body:
